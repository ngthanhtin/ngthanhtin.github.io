...
Đối với text presentation, ở bài báo họ sử dụng 2 cachs: <b>(1) dùng lstm và sử dụng hidden để làm vector representation cho text</b> và <b>(2)Sử dụng unigram để lấy vector presentation cho từng word, sau đó concatenate các vector này lại tạo thành vector representation cho text</b><br/>
